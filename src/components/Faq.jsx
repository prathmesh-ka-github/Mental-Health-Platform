...
const Faq = () => {
    ...
    return (
        <div className='flex justify-center flex-col items-center my-60 '>
            <div className="z-10 font-bold txt-main mobile:text-[40px] lg:text-[50px] flex mobile:flex-col mobile:items-center lg:flex-row">
                Frequently Asked
            ...
            <div className='flex justify-center mt-20 h-[60%] w-[90vw]'>
                <div className='lg:w-[70vw] mobile:w-[100vw]'>
                    ...
                    <div className='mobile:px-4 lg:px-8 z-[5] relative'>
                        <div id='blueborder'
                            className='flex w-[100%] justify-between txt-light mobile:text-[20px] lg:text-[25px] mobile:p-2 lg:p-6 cursor-pointer'>
                            <h1>Q. What about my confidentiality?</h1>
                            <span>-</span>
                        </div>
                        <div id='blueborder2' className='content show lg:text-[20px]'>
