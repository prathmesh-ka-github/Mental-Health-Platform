...
const Home = () => {
  return (
    <div className="flex text-center justify-center items-center flex-col pt-[120px] ">
      ...
      <div className='z-10 mb-80 lg:mt-60 mobile:mt-40'>
        ...
        <div className="txt-ternary-light lg:text-[20px] mt-3 md:flex-row flex mobile:flex-col mobile:items-center justify-center">
      ...
      <div>
        <div className="inline z-10 font-bold txt-main mt-[10rem] mobile:text-[40px] lg:text-[64px] mobile:flex-col lg:flex-row">
          Your confidentiality <span className="txt-light ">&nbsp;is our priority</span>
        </div>
        <br />
        <button className="text-white back-main px-[80px] py-[15px] mt-10 mb-60 rounded-md text-[25px]  hover:bg-blue-400 active:bg-blue-500 transition-all" >View more</button>
      </div>
    </div>
  )
}
